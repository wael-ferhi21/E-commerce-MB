 ...
 */
class getSousCategorieRepositoryService extends App_KernelDevDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'SousCategorieRepository.php';

        return $container->privates['App\\Repository\\SousCategorieRepository'] = new \App\Repository\SousCategorieRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
